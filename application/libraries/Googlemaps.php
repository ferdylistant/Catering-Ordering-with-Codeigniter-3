...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyBY9CzngNQf972L1qC-Afzn3zmkmVHrYa0'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
