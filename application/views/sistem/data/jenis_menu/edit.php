  ...
  <div class="col-12 stretch-card">
    <div class="card">
      <div class="card-body" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
        ...
        <?php echo form_open('sistem/jenis_menu_update/','class="form-horizontal"'); ?>
        <div class="form-group row">
          <label class="col-sm-3 col-form-label">Jenis Menu</label>
          <div class="col-sm-9">
            <input type="hidden" class="form-control" name="id_jenis_menu" value="<?php echo $id_jenis_menu;?>">
            <input type="text" class="form-control" name="jenis_menu" value="<?php echo $jenis_menu;?>">
          </div>
        </div>                      
