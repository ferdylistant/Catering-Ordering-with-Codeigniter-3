                ...
                <a class="dropdown-item preview-item" href="<?php echo base_url()?>sistem/nota/<?php echo $value['id_order']?>">
                  ...
                  <div class="preview-thumbnail">
                    ...
                    <?php }
                      ...
                      <img src="<?php echo base_url();?>upload/pelanggan/<?php echo $value['poto_profil']?>" alt="image" class="profile-pic">
                    <?php }?>
                  ...
                  <?php }
                    ...
                    <span class="badge badge-secondary font-weight-light small-text text-dark" style="margin-left: -1px">Pemesanan Selesai</span>
                  <?php }
