<div class="row purchace-popup">
  <div class="col-12">
    <span class="d-block d-md-flex align-items-center text-center" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
      ...
      <li>
        <a href="<?php echo base_url();?>sistem/kategor_blog" class="mt-2 text-dark">Kategori Blog</a>
      </li>
    </ul></span>
  </div>
  ...
  <div class="col-12 stretch-card">
    <div class="card">
      <div class="card-body" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
        ...
        <?php echo form_open('sistem/kategori_blog_simpan/','class="form-horizontal"'); ?>
        <div class="form-group row">
          <label for="Kategori Blog" class="col-sm-3 col-form-label">Kategori Blog</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" name="nama_kategoriblog" placeholder="Kategori Blog" value="<?php echo set_value('nama_kategoriblog')?>">
          </div>
        </div>
        <div class="py-3">
