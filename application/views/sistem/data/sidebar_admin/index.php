<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <li class="nav-item nav-profile">
      <div class="nav-link">
        <div class="user-wrapper">
          ...
          <?php else: ?>
            <img class="img-xs rounded-circle" src="<?php echo base_url();?>images/admin/<?= $auth['foto']?>" alt="profile image">
          <?php endif ?>
        </div>
  ...
  <li class="nav-item">
    ...
    <div class="collapse" id="master">
      <ul class="nav flex-column sub-menu">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url();?>sistem/jenis_menu">
            <i class="menu-icon fa fa-table"></i>
            <span class="menu-title">Jenis Menu</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url();?>sistem/kategori_galeri">
            <i class="menu-icon fa fa-table"></i>
            <span class="menu-title">Kategori Galeri</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url();?>sistem/blog">
            <i class="menu-icon fa  fa-rss-square"></i>
            <span class="menu-title">Blog</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url();?>sistem/kategori_blog">
            <i class="menu-icon fa fa-table"></i>
  ...
  <li class="nav-item">
    ...
    <div class="collapse" id="laporan">
      <ul class="nav flex-column sub-menu">
        <li class="nav-item">
          <a href="<?php echo base_url();?>sistem/laporan" class="nav-link">
  ...
  <li class="nav-item">
    <a href="<?php echo base_url();?>sistem/tentang_kami" class="nav-link">
