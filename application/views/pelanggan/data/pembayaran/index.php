  ...
  <div class="container">
   <div class="row">
    <div class=" p-t-50 wrap-item-mainmenu p-b-300">
     <h3 class="tit-mainmenu tit10 p-b-35 m-l-16"><img src="<?php echo base_url('images/icons/png/010-paymentmethod.png') ?>" style="width: 40px;">KONFIRMASI PEMBAYARAN</h3>
   </div>
 </div>
 <?php
 if ($pemesanan['status_order'] == "0") {?>
   <div class="row bg-white" style="border-radius: 10px">
    <div class="col-lg-6 p-b-30 p-t-18">
     <p class="p-b-10">Berikut adalah riwayat pemesanan Anda</p>
...
<div class="col-lg-6 p-b-30 p-t-48">
  <form method="post" enctype="multipart/form-data" class="wrap-form-booking">
    <div class="row">
      <h3 class="m-l-130 m-b-10 tit7"><img src="<?php echo base_url('images/icons/png/016-EDC.png') ?>" style="width: 40px;">Metode Pembayaran:</h3>
...
if (isset($_POST['kirim'])) 
{
  ...
  $this->pelanggan_model->KirimPembayaran($id_order);

}
?>
<?php $hasil = $pemesanan['total_order']*0.7; ?>
<div class="col-lg-6 p-b-30" style="margin-top: -200px">
 <ul class="list-group">
  <li class="list-group-item"><img src="<?php echo base_url('images/icons/png/043-email.png') ?>" class="m-l-190" style="width: 23%;opacity: 0.2;position: absolute;"><p style="color: red"><i class="fa  fa-exclamation-circle"></i> CATATAN:</p>Jika ingin melakukan pembayaran DP, silhkan melunasi sesuai total pemesanan saat pengambilan pesanan. DP minimal 70% dari total pemesanan. Jika kurang dari yang sudah ditetapkan, maka akan kami batalkan. Total pembayaran DP Anda senilai: <b><?php echo rupiah($hasil)?></b>. Mohon diperhatikan dengan jelas, terimakasih. Ttd KAMPUNG JAWA,Resto.<p><a href="<?php echo base_url()?>syarat_dan_ketentuan" class="btn-link">Syarat & Ketentuan</a></p></li>
</ul>
</div>
</div>
...
if ($this->session->flashdata('salah')) {
  ...
  <p>Pembayaran salah, cek kembali total pemesanan Anda!</p>
  </div>           
  </div>
  </div>
  </div>";
  ...
  <div class='modal-body'>
  <p>Terima kasih telah melakukan pembayaran. Happy Order!</p>
  </div>           
  </div>
  </div>
  </div>";
  ...
  <div class='modal-body'>
  <p>Jika ingin pembayaran DP, minimal 70% dari total harga pemesanan!</p>
  </div>           
  </div>
  </div>
  </div>";
  ...
  <div class='modal-body'>
  <p>Lakukan pembayaran sesuai batas tanggal yang ditentukan!</p>
  </div>           
  </div>
  </div>
  </div>";
